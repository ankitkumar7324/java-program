...
public class delete_in_heap2_maxheap 
{
     static class Heap
    {
        ...
        public void add(int data)  //whole t.c of addition function is 0(logn)
        {
            ...
            while(arr.get(x) > arr.get(par))  //0(logn)            //changes >
            {
        ...
        private void heapify(int i)
        {
            ...
            if(left<arr.size() && arr.get(left)>arr.get(maxidx))        //changes >
            {
                maxidx = left;
            }
            if(right<arr.size() && arr.get(right)>arr.get(maxidx))      //changes >
            {
                maxidx = right;
            }
